// Package allof is a test fixture demonstrating the allOf combinator: a named
// embedded struct is composed via allOf when its field is tagged asyncapi:"allOf".
package allof
